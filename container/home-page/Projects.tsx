...
export default function Projects() {
	return (
		<section className="w-full rounded-t-[20px]">
			<Heading title="Featured projects" className="padding-x padding-y pb-[50px] border-b border-[#21212155]" />
			...
			<div className="w-full flex justify-center">
				<div className="flex items-center justify-between bg-secondry cursor-pointer rounded-full group">
					<RoundButton href="/presentation" title="view all case studies" bgcolor="#000" className="bg-white text-black" style={{ color: '#fff' }} />
				</div>
			</div>
		</section>
	);
