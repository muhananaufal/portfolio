...
export default function RoundButton({ href, title, className, bgcolor, style }: { href: string; title: string; className?: string; bgcolor: string; style: React.StyleHTMLAttributes<HTMLDivElement>['style'] }) {
	return (
		<TransitionLink className="small-text uppercase font-normal font-NeueMontreal" href={href}>
