...
const FuzzyText: React.FC<FuzzyTextProps> = ({ children, fontSize = 'clamp(2rem, 8vw, 8rem)', fontWeight = 900, fontFamily = 'inherit', color = '#35292E', enableHover = true, baseIntensity = 0.18, hoverIntensity = 0.5 }) => {
